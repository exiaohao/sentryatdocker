...
SENTRY_OPTIONS['mail.password'] = 'uNJ1tc1Mzd7zi1b'
SENTRY_OPTIONS['mail.username'] = 'sentry@noreply.meshlab.cn'
SENTRY_OPTIONS['mail.port'] = 25
SENTRY_OPTIONS['mail.use-tls'] = False

# The email address to send on behalf of
SENTRY_OPTIONS['mail.from'] = 'sentry@noreply.meshlab.cn' #os.environ.get('SENTRY_SERVER_EMAIL') or 'root@localhost'
